const produtos = [
    {
        ...
        semJuros: true,
        loja: "Mercado Livre",
        imagem: "https://http2.mlstatic.com/D_NQ_NP_2X_933021-MLA99446594058_112025-F.webp",
        link: "#"
    },
    {
        nome: "Lenovo LOQ",
        ...
        semJuros: true,
        loja: "Mercado Livre",
        imagem: "https://http2.mlstatic.com/D_NQ_NP_2X_891763-MLA112377969125_052026-F.webp",
        link: "#"
    },
    {
        nome: "Dell Alienware C7",
        marca: "dell",
        ...
        semJuros: true,
        loja: "Mercado Livre",
        imagem: "https://http2.mlstatic.com/D_NQ_NP_2X_973553-MLA106776428822_022026-F.webp",
        link: "#"
    }
]
...
const quantidadeEncontrada = document.querySelector(
...
function criarCard(produto) {
    ...
    especificacoes.textContent =
        `${produto.processador} | ` +
        `${produto.gpu.toUpperCase()} | ` +
        `${produto.ram} GB RAM | ` +
        `${produto.armazenamento} GB SSD | ` +
        `${produto.tela}" | ` +
...
function atualizarQuantidade(quantidade) {
    ...
    quantidadeEncontrada.textContent =
        `${quantidade} notebook${quantidade !== 1 ? "s" : ""} encontrado${quantidade !== 1 ? "s" : ""}`
}
...
function filtrarProdutos(listaProdutos) {
    ...
    return listaProdutos.filter((produto) => {
        ...
        const correspondeGpu =
            gpus.length === 0 ||
            gpus.includes(produto.gpu)

        const correspondeRam =
            memorias.length === 0 ||
            memorias.includes(String(produto.ram))

        const correspondeArmazenamento =
            armazenamentos.length === 0 ||
            armazenamentos.includes(
                String(produto.armazenamento)
            )

        const correspondePreco =
            produto.precoAtual <= precoMaximo

        const correspondeParcelamento =
